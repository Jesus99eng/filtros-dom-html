...
var checkBoxWomenClothing = document.getElementById("checkBoxWomenClothing")
var checkBoxMayores50 = document.getElementById("checkBoxMayores50")
var checkBoxMenores50 = document.getElementById("checkBoxMenores50")
...
var arrayFilterCheckBox = [checkBoxElectronics, checkBoxWomenClothing, checkBoxMayores50, checkBoxProducto90, checkBoxEncontrarId10]
...
//filtrar los productos por categoria women clothing//

checkBoxWomenClothing.addEventListener('change', () => {
    if (checkBoxWomenClothing.checked) {
        let arrayWomenClothing = filtrarCategoriaWomenClothing(productosArray)
        renderizarProductos(arrayWomenClothing)
    } else {
...
checkBoxElectronics.addEventListener('change', () => {
    if (checkBoxElectronics.checked) {
        let arrayElectronics = filtrarCategoriaElectronics(productosArray)
        renderizarProductos(arrayElectronics)
    } else {
        validarFiltrosVacios()
    }
})
...
//filtrar los productos menores a 50

checkBoxMenores50.addEventListener('change', () => {
    if (checkBoxMenores50.checked) {
...
function generarUISubproducto(producto) {
    return`<tr>
                ...
                <td class="p-2">
                    <div class="text-center w-16">${1}</div>
                </td>
                <td class="p-2">
...
//TODO 3: Filtros para la categoria electronics // ya
//TODO 4: Filtros para la categoria women's clothing // ya
